Now that you've successfully got your SparkFun Magnetic Imaging Tile up and running, it's time to incorporate it into your own project! For more information, check out the resources below:

* [Schematic (PDF)](../assets/board_files/Magnetic_Imaging_Tile_Schematic_V10.pdf)
* [Eagle Files (ZIP)](../assets/board_files/Magnetic-Imaging-Tile_v10.zip)
* [Board Dimensions (PNG)](../assets/img/SparkFun_Magnetic_Imaging_Tile_Board_Dimensions.png)
* Component Datasheets
    * [DRV5053 Analog-Bipolar Hall Effect Sensor](../assets/component_documentation/drv5053.pdf)
    * [AD7680 16-bit 100kSPS Successive Approximation ADC](../assets/component_documentation/AD7680.pdf)
    * [74HC590A Binary Counter](../assets/component_documentation/sn54hc590a.pdf)
    * [SN74LVC1G139DCTR 2-to-4 Line Decoder](../assets/component_documentation/sn74lvc1g139.pdf)
